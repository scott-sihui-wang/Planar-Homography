...
figure(2);
imshow(compositeH(bestH2to1, scaled_hp_img, desk_img));%here I had an edit to the original code. 'inv(bestH2to1)' is not compatible with the design of 'compositeH', it should be 'bestH2to1' here.
